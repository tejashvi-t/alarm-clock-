...
// set audio for alarm
const audio = new Audio('Alarm Clock 5.mp3');
audio.loop = true;
...
//   TO PLAY  AUDIO AT CORRECT TIME 
function ringing(now){
    audio.play();
    alert(` hey its time to wake up ${now}`)
}


// TIME GET UPDATED EVERY SECOND
function updateTime() {
    var today = new Date();
...
//     if yes, ringing() is called
  ...
  //IT SET OUR TIME FROM 0:0:0  TO 00:00:00
